...
function restyle() {
  ...
  document.getElementById("halfButton").style.fontFamily = font[random1];
  document.getElementById("halfButton").style.backgroundcolor = background[random2];
  document.getElementById("halfButton").style.size = size[random3];
  document.getElementById("fortuneOutput").style.fontFamily = font[random1];
  document.getElementById("fortuneOutput").style.backgroundcolor = background[random2];
  document.getElementById("fortuneOutput").style.size = size[random3];
